...
namespace Dorisoy.Pan.MediatR.Handlers
{
    public class SharedVirtualFolderCommandHandler : IRequestHandler<SharedVirtualFolderCommand, bool>
    {
        ...
        public async Task<bool> Handle(SharedVirtualFolderCommand request, CancellationToken cancellationToken)
        {
            ...
            var hierarchyFolder = new HierarchyFolder { Id = orignalVirtualFolder.Id, ParentId = orignalVirtualFolder.ParentId, Level = 0, Name = orignalVirtualFolder.Name, PhysicalFolderId = orignalVirtualFolder.PhysicalFolderId.Value };
