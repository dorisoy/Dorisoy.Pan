        ...
        private void SetModifiedInformation()
        {
            foreach (var entry in Context.ChangeTracker.Entries<BaseEntity>())
            {
                if (entry.State == EntityState.Added)
                {
                    ...
                    entry.Entity.CreatedBy = entry.Entity.CreatedBy.HasValue ? entry.Entity.CreatedBy : _userInfoToken.Id;
                    entry.Entity.ModifiedBy = entry.Entity.ModifiedBy.HasValue ? entry.Entity.ModifiedBy : _userInfoToken.Id;
