...
public class DocumentPageViewModel : MainPageViewModelBase
{
    ...
    public DocumentPageViewModel(IUsersService usersService) : base()
    {
        ...
        this.WhenActivated((CompositeDisposable disposables) =>
        {
            ...
            _documentService
            .Connect()
            .Sort(SortExpressionComparer<DocumentFolderModel>.Descending(s => s.DocType).ThenByDescending(s => s.CreatedDate))
            .Page(_pager)
        ...
        //Items.WhenAnyValue(s => s.Count > 0).ToProperty(this, x => x.IsBusy, out isBusy);
    }
