...
public partial class Dialog
{
    ...
    public static readonly StyledProperty<ICommand> CloseButtonCommandProperty =
        AvaloniaProperty.Register<Dialog, ICommand>(nameof(CloseButtonCommand));
    ...
    public static readonly StyledProperty<object> CloseButtonCommandParameterProperty =
        AvaloniaProperty.Register<Dialog, object>(nameof(CloseButtonCommandParameter));

    /// <summary>
    /// Defines the <see cref="CloseButtonText"/> property
    /// </summary>
    public static readonly StyledProperty<string> CloseButtonTextProperty =
        AvaloniaProperty.Register<Dialog, string>(nameof(CloseButtonText));

    /// <summary>
    /// Defines the <see cref="DefaultButton"/> property
    /// </summary>
    public static readonly StyledProperty<DialogButton> DefaultButtonProperty =
        AvaloniaProperty.Register<Dialog, DialogButton>(nameof(DefaultButton), DialogButton.None);
    ...
    public static readonly StyledProperty<bool> IsPrimaryButtonEnabledProperty =
        AvaloniaProperty.Register<Dialog, bool>(nameof(IsPrimaryButtonEnabled), true);
    ...
    public static readonly StyledProperty<bool> IsSecondaryButtonEnabledProperty =
        AvaloniaProperty.Register<Dialog, bool>(nameof(IsSecondaryButtonEnabled), true);
    ...
    public static readonly StyledProperty<ICommand> PrimaryButtonCommandProperty =
        AvaloniaProperty.Register<Dialog, ICommand>(nameof(PrimaryButtonCommand));
    ...
    public static readonly StyledProperty<object> PrimaryButtonCommandParameterProperty =
        AvaloniaProperty.Register<Dialog, object>(nameof(PrimaryButtonCommandParameter));

    /// <summary>
    /// Defines the <see cref="PrimaryButtonText"/> property
    /// </summary>
    public static readonly StyledProperty<string> PrimaryButtonTextProperty =
        AvaloniaProperty.Register<Dialog, string>(nameof(PrimaryButtonText));
    ...
    public static readonly StyledProperty<ICommand> SecondaryButtonCommandProperty =
        AvaloniaProperty.Register<Dialog, ICommand>(nameof(SecondaryButtonCommand));
    ...
    public static readonly StyledProperty<object> SecondaryButtonCommandParameterProperty =
        AvaloniaProperty.Register<Dialog, object>(nameof(SecondaryButtonCommandParameter));
    ...
    public static readonly StyledProperty<string> SecondaryButtonTextProperty =
        AvaloniaProperty.Register<Dialog, string>(nameof(SecondaryButtonText));
    ...
    public static readonly StyledProperty<IDataTemplate> TitleTemplateProperty =
        AvaloniaProperty.Register<Dialog, IDataTemplate>(nameof(TitleTemplate));

    /// <summary>
    /// Defines the <see cref="FullSizeDesired"/> property
    /// </summary>
    public static readonly StyledProperty<bool> FullSizeDesiredProperty =
        AvaloniaProperty.Register<Dialog, bool>(nameof(FullSizeDesired));
    ...
    /// </summary>
    public event TypedEventHandler<Dialog, EventArgs> Opening;

    /// <summary>
    /// Occurs after the dialog is opened.
    /// </summary>
    public event TypedEventHandler<Dialog, EventArgs> Opened;

    /// <summary>
    /// Occurs after the dialog starts to close, but before it is closed and before the Closed event occurs.
    /// </summary>
    public event TypedEventHandler<Dialog, DialogClosingEventArgs> Closing;

    /// <summary>
    /// Occurs after the dialog is closed.
    /// </summary>
    public event TypedEventHandler<Dialog, DialogClosedEventArgs> Closed;

    /// <summary>
    /// Occurs after the primary button has been tapped.
    /// </summary>
    public event TypedEventHandler<Dialog, DialogButtonClickEventArgs> PrimaryButtonClick;

    /// <summary>
    /// Occurs after the secondary button has been tapped.
    /// </summary>
    public event TypedEventHandler<Dialog, DialogButtonClickEventArgs> SecondaryButtonClick;

    /// <summary>
    /// Occurs after the close button has been tapped.
    /// </summary>
    public event TypedEventHandler<Dialog, DialogButtonClickEventArgs> CloseButtonClick;
