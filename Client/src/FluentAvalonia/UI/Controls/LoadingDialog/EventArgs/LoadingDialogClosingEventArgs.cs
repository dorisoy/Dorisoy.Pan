...
/// </summary>
public class LoadingDialogClosingEventArgs : EventArgs
{
    internal LoadingDialogClosingEventArgs(LoadingDialogResult res)
    {
        Result = res;
    }
    ...
    /// <summary>
    /// Gets the <see cref="LoadingDialogResult"/> of the closing event.
    /// </summary>
