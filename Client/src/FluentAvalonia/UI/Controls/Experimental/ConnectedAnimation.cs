...
public class ConnectedAnimation
{
    ...
    private void ConfigureConnectedAnimation(Visual destination, IList<Visual> coordinatedVisuals = null)
    {
        ...
        var v3 = destVis.Offset + delta;
        var dv3 = destVis.Offset;

        offsetAnim.SetVector3Parameter("StartValue", new Vector3((float)v3.X, (float)v3.Y, (float)v3.Z));
        offsetAnim.SetVector3Parameter("FinalValue", new Vector3((float)dv3.X, (float)dv3.Y, (float)dv3.Z));
