...
public sealed class GifDecoder : IDisposable
{
    ...
    {
        var tmpB = System.Buffers.ArrayPool<byte>.Shared.Rent(MaxTempBuf);
        ...
        System.Buffers.ArrayPool<byte>.Shared.Return(tmpB);
    }
    ...
    private void ProcessFrameData()
    {
        ...
        var tempBuf = System.Buffers.ArrayPool<byte>.Shared.Rent(MaxTempBuf);
